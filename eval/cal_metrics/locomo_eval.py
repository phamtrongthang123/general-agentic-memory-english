...
def main():
    ...
    INPUT_DIR = r"/share/project/bingyu/code/general-agentic-memory/results/locomo_output"  # 改为文件夹路径
    OUTPUT_DIR = r"/share/project/bingyu/code/general-agentic-memory/results/locomo_output"  # 输出到同一文件夹
    ...
    for subdir in subdirs:
        input_json = os.path.join(INPUT_DIR, subdir, "qa_results.json")  # 新格式文件名
