    ...
    try:
        ...
        for i, qi in enumerate(qas, 1):
            ...
            try:
                ...
                print("生成答案...")
                summary_answer = answer_with_summary(cat, research_summary, q, generator)
                memory_answer = answer_with_memory(cat, final_memory_str, q, generator)
...
def main():
    ...
    parser.add_argument("--outdir", type=str, default="/share/project/bingyu/code/general-agentic-memory/results/locomo_output",
                        help="输出目录")
    parser.add_argument("--start-idx", type=int, default=9, help="开始样本索引")
